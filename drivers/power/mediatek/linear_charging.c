...
printk("[yixuhong] BMT_status.charger_type =%d \n",BMT_status.charger_type);
       ...
       //yixuhong 20151116 add for test
			...
			printk("[yixuhong] standard charger cc mode g_temp_standar_charger_value =%d \n",g_temp_standar_charger_value);
			...
			printk("[yixuhong] standard charger cc mode g_temp_CC_value =%d \n",g_temp_CC_value);
     ...
     g_temp_CC_value = batt_cust_data.ac_charger_current;
		...
		printk("[yixuhong] standard charger cc mode batt_cust_data.tinno_1_5a_charger_current =%d \n",batt_cust_data.tinno_1_5a_charger_current);
